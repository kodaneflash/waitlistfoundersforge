      ...
      <section className=" mt-5  ">
        <div className="space-y-4 ">
          <div className="space-y-2 text-center">
            ...
            <div className="flex items-center justify-center">
              ...
              <div className="p-[1px] bg-transparent  relative">
                <div className="p-2 ">
                  ...
                  Don’t miss out on creating your next big thing
                  </span>
                </div>
              </div>
            ...
            zero to millions. Secure your place on our waitlist today for exclusive access to
          ...
          >
            ...
            <div className="relative z-10">
              <p className="lg:text-justify  leading-6 mb-6">
                I'm doing a giveaway on the launch of this course
                website by June. If you sign up today, which will only
                take a few seconds and 1 click, you'll automatically be
                enlisted in our giveaway and 10 lucky people will get free
                access to all of our courses and personalized support.
              </p>
