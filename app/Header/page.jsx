...
let Icons = [
  { name: <PiTwitterLogoThin />, href: "https://twitter.com/thefoundersforge" },
  { name: <PiInstagramLogoThin />, href: "https://instagram.com/thefoundersforge " },
...
const people = [
  ...
  },
  {
    ...
    designation: "@thefoundersforge",
    image: "/img/alarm.png",
    href: "https://twitter.com/thefoundersforge",
  },
  {
    id: 3,
    name: "GITHUB",
...
function Headpage() {
  ...
  {Icons.map((icon, index) => (
    <div
      key={index} // Changed from icon.name to index for key since JSX elements might not be unique
